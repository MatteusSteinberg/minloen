          ...
          actions={(user: IUser) => (
            <>
              <td className="flex items-center justify-end px-8 py-4 text-right text-nowrap">
                ...
                <Link to={`/rediger-medarbejder/${user.id}`} className="mr-2 flex items-center text-darkPrimaryLight bg-gradientmain border border-solid border-[rgba(231,231,233,0.2)] hover:border-[rgba(231,231,233,0.5)] transition-colors duration-300 rounded-xl h-12 w-12 justify-center">
