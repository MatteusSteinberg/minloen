...
const Navigation = (props: Props) => {
    ...
    return (
        <header className={`fixed top-0 left-0 z-50 flex items-center justify-between w-full px-20 py-5 ${scrolled ? "bg-white border-b border-solid border-lightBorder" : "bg-transparent border-none"}`}>
            ...
            <div className="z-10 flex items-center gap-4">
                <Link to="/login" className="text-text font-medium-normal">
                    Log ind
                </Link>
                <Link to="/signup" className="py-4 text-white px-7 rounded-xl bg-lightPrimary">
