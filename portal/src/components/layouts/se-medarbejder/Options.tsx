...
const Options = (props: Props) => {
  ...
  return (
    <div className="flex items-center justify-between pb-3 mb-16 border-b border-solid border-darkBorder">
      ...
      <div className="flex items-center justify-center gap-4">
        <Link to={`/opret-loenseddel/${id}?fast=true`} className="text-white font-small-normal">
          Opret fast lønseddel
        </Link>
        <Link to={"/opret-loenseddel/" + id} className="text-darkPrimaryLight font-small-normal">
