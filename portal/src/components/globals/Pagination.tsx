...
const Pagination = ({ onClick, currentPage, count, size }: {
    ...
    <div className="flex items-center justify-center gap-1">
      ...
      {pages.map(pageNumber => <>
        <button
          className={
            onPage === pageNumber ?
              "w-10 h-10 flex items-center justify-center relative bg-gradientmain border-[rgba(231,231,233,0.2)] border-solid border text-white font-small-medium rounded-lg" :
              "relative flex items-center justify-center w-10 h-10 text-primaryLight font-small-medium"}
