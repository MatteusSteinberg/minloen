    ...
    return (
        <>
            <button ref={buttonRef} className="relative w-10 h-10 rounded-full group" onClick={() => setToggleMenu(!toggleMenu)}>
                <svg className="inline-block w-6 h-6 fill-lightSecondaryLight dark:fill-[#6c7275] transition-colors hover:fill-darkPrimaryLight" width="24" height="24" viewBox="0 0 24 24">
