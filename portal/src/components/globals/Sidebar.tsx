...
const Sidebar = ({ setShowSidebar, showSidebar }: ISidebar) => {
    ...
    return (
        <>
                ...
                {showSidebar && (
                    <svg width="167" height="38" viewBox="0 0 167 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            ...
                            fill="#CDE4BA"
                        />
                        <path d="M49.6073 29.8835V6.39866H53.9526L62.1371 23.1044L70.3391 6.39866H74.6669V29.8835H70.9673V13.0567L63.4459 28.2233H60.8283L53.3069 13.0567V29.8835H49.6073Z" className="fill-text dark:fill-white" />
                        <path d="M79.9894 7.71299C79.9894 6.46784 80.862 5.60316 82.1185 5.60316C83.3749 5.60316 84.2649 6.46784 84.2649 7.71299C84.2649 8.95813 83.3749 9.82282 82.1185 9.82282C80.862 9.82282 79.9894 8.95813 79.9894 7.71299ZM83.8461 29.8835H80.3908V13.2816H83.8461V29.8835Z" className="fill-text dark:fill-white" />
                        <path d="M92.6065 29.8835H89.1512V13.2816H92.6239V15.3741C93.1824 14.5267 94.7704 12.9357 97.772 12.9357C102.379 12.9357 104.805 15.7718 104.805 19.8013V29.8835H101.349V20.5276C101.349 17.7779 99.8312 16.1869 97.231 16.1869C94.6832 16.1869 92.6065 17.7779 92.6065 20.5276V29.8835Z" className="fill-text dark:fill-white" />
                        <path d="M127.474 26.5804V29.8835H110.302V6.39866H113.984V26.5804H127.474Z" className="fill-text dark:fill-white" />
                        <path
                            ...
                            className="fill-text dark:fill-white"
                        />
                        <path d="M154.802 29.8835H151.346V13.2816H154.819V15.3741C155.378 14.5267 156.966 12.9357 159.967 12.9357C164.574 12.9357 167 15.7718 167 19.8013V29.8835H163.545V20.5276C163.545 17.7779 162.026 16.1869 159.426 16.1869C156.878 16.1869 154.802 17.7779 154.802 20.5276V29.8835Z" className="fill-text dark:fill-white" />
                    </svg>
                )}
            ...
            <div className="h-full overflow-y-auto grow scroll-smooth no-scrollbar">
                <div className={showSidebar ? "px-0" : "px-2"}>
                    {Links.map((link: ILinkProps, index: number) => (
                        <NavLink to={link.link} className={`w-full flex items-center h-12 font-normal text-[15px] font-default text-text dark:text-[rgba(232,236,239,.75)] rounded-lg transition-all dark:hover:text-white ${showSidebar ? "px-5" : "px-3"}`}>
                            {link.icon}
                ...
                <div className="pb-6 mb-auto">
                    <button onClick={() => setHideAdmin(!hideAdmin)} className="flex items-center h-12 font-light text-[13px] font-default text-text dark:text-[rgba(232,236,239,.75)] rounded-lg px-[23px]">
            ...
            <div className="absolute left-0 bottom-0 right-0 pb-6 dark:bg-primarySupport px-3 before:absolute before:left-0 before:right-0 before:bottom-full before:h-10 dark:before:bg-gradient-to-t dark:before:from-[#131617] dark:before:to-[rgba(19,22,23,0)] dark:before:pointer-events-none md:px-4">
                <div className={`mb-3 rounded-[14px] border border-solid border-borderLight dark:border-none ${showSidebar ? "bg-white dark:bg-secondarySupport dark:shadow-[0_1.25rem_1.5rem_0_rgba(0,0,0,0.5)]" : "bg-transparent shadow-none flex justify-center"}`}>
                    {showSidebar ? (
