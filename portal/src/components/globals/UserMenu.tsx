    ...
    return (
        <>
            ...
            <div ref={node} className={`absolute transition-all duration-150 md:right-0 transform ${toggleMenu ? "scale-100 opacity-100 visible" : "scale-95 opacity-0 invisible"}`}>
                <div className="absolute top-full -right-[158px] md:right-0 w-[286px] mt-10 p-4 bg-darkPrimarySupport border border-solid border-[rgba(51,54,62,0.50)] rounded-2xl shadow-[0px_48px_64px_-16px_rgba(0,0,0,0.25)]">
                    ...
                    <div className="flex flex-col px-4 mt-3 bg-darkSecondarySupport rounded-2xl">
                        <button onClick={() => setIsModalOpen(true)} className="flex items-center w-full h-12 text-white transition-colors dark:text-dark group font-standard-medium hover:text-darkPrimaryLight">
                            <svg className="inline-block w-6 h-6 mr-4 fill-[#6c7275] transition-colors group-hover:fill-darkPrimaryLight" width="24" height="24" viewBox="0 0 24 24">
                        ...
                        <button className="flex items-center w-full h-12 text-white transition-colors dark:text-dark group font-standard-medium hover:text-darkPrimaryLight">
                            <svg className="inline-block w-6 h-6 mr-4 fill-[#6c7275] transition-colors group-hover:fill-darkPrimaryLight" width="24" height="24" viewBox="0 0 24 24">
